...
class Model(nn.Module):
    def __init__(self, num_class=120, num_point=25, num_person=2, graph='graph.ntu_rgb_d_Block.Graph', graph_args=dict({'labeling_mode': 'spatial'}), in_channels=3,
    ...
    def forward(self, x):
        ...
        # print(x.shape)
        # exit()
        x = x.view(N, M, c_new, -1, V).mean(1) # N,C,T,V
